...
def PostListView(request):
    ...
    return render(request, 'apphn/postlist.html', context)
...
def UserInfoView(request, username):
    ...
    context = {'user': user, }
    return render(request, 'apphn/userinfo.html', context)
...
def UserSubmissions(request, username):
    ...
    for post in posts:
        post.count_votes()
        post.count_comments()
    return render(request, 'apphn/user_posts.html', {'posts': posts})
...
def EditListView(request, id):
    ...
    return render(request, 'apphn/submit.html', {'form': form})
...
def CommentListView(request, id):
    ...
    return render(request, 'apphn/commentpost.html', context)
...
def CommentReplyView(request, id1, id2):
    ...
    return render(request, 'apphn/reply_post.html', context)
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'apphn/auth_signup.html', {'form': form})
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, 'apphn/auth_signin.html', {'form': form})
